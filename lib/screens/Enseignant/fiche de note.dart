...
class FicheDeNotes extends StatefulWidget {
  const FicheDeNotes({super.key});

  @override
  _FicheDeNotesState createState() => _FicheDeNotesState();
}

class _FicheDeNotesState extends State<FicheDeNotes> {
